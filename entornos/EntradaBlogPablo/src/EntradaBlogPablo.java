...
//es negativo, lanza una excepción.
    public EntradaBlogPablo(int id, String autor, String texto) throws IllegalArgumentException {
    ...
    public static void main(String[] args) {
        //Modificar.
        EntradaBlogPablo e1 = new EntradaBlogPablo(3, "ana", "Últimas noticias, está disponible BixBy 2.0");
